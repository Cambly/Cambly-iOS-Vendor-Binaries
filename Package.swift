...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "Sentry",
      url: "https://github.com/Cambly/Cambly-iOS-Vendor-Binaries/releases/download/sentry-9.29.0/Sentry.xcframework.zip",
      checksum: "44f942af79059d141293d5824985859fe7d8478bfd0010d66d98070fa8ce7c15"
    ),
